...
; Target	: NMTRAN 7.3.0
; Model 	: UseCase10_1
; Dated 	: Wed Aug 05 14:51:23 BST 2015

$PROBLEM "UseCase10_1.mdl - generated by MDL2PharmML v.6.0"
...
F = CENTRAL/S2
CC_DES =  F
DADT(1) = (((-(K23*PERIPHERAL1)+K32*PERIPHERAL1)+KA*AD4)-K*CENTRAL)
DADT(2) = (K23*CENTRAL-K32*CENTRAL)
DADT(3) = -(KA*AD4)
...
$TABLE  ID CL VC Q VP KA TLAG ALAG1 V K K23 K32 S2 ETA_PPV_CL ETA_PPV_VC ETA_PPV_Q ETA_PPV_VP ETA_PPV_KA ETA_PPV_TLAG NOAPPEND NOPRINT FILE=patab
