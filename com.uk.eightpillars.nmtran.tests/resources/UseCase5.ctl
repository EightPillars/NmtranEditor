...
; Target	: NMTRAN 7.3.0
; Model 	: UseCase5
; Dated 	: Wed Aug 05 14:52:20 BST 2015

$PROBLEM "UseCase5.mdl - generated by MDL2PharmML v.6.0"
...
MU_1 = LOG(POP_CL)+BETA_CL_WT * LOGTWT+POP_FCL_FEM * TSEX+BETA_CL_AGE * TAGE;
CL = EXP(MU_1 + ETA(1));
