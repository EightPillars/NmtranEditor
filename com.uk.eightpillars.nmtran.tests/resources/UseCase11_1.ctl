...
; Target	: NMTRAN 7.3.0
; Model 	: UseCase11_1
; Dated 	: Wed Aug 05 14:51:29 BST 2015

$PROBLEM "UseCase11_1.mdl - generated by MDL2PharmML v.6.0"
...
MU_1 = LOG(POP_BASECOUNT)+CP;
LAMBDA = EXP(MU_1 + ETA(1));
...
$TABLE  ID LAMBDA ETA_PPV_EVENT NOAPPEND NOPRINT FILE=patab
