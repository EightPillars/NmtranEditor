...
; Target	: NMTRAN 7.3.0
; Model 	: UseCase5_1
; Dated 	: Wed Aug 05 14:52:24 BST 2015

$PROBLEM "UseCase5_1.mdl - generated by MDL2PharmML v.6.0"

$INPUT  ID TIME WT SEX AGE AMT DVID=DROP DV MDV
...
MU_1 = LOG(POP_CL)+BETA_CL_WT * LOGTWT+BETA_CL_AGE * TAGE;
CL = EXP(MU_1 + ETA(1));
...
$TABLE  ID TIME WT SEX AGE AMT MDV PRED IPRED RES IRES WRES IWRES Y DV NOAPPEND NOPRINT FILE=sdtab
